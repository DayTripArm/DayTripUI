        ...
        <div className='container'>
            <div className='d-flex justify-content-end'>
                <div className='col-xxl-10 col-xl-11 p-0'>
                    <h2 className='text__blue mt-6 mb-md-8 mt-md-9 mt-xl-11 mb-xl-9 mb-xxl-11 mt-xxl-13'>{t("my_car_page.page_title")}</h2>
                    <div className='row'>
                        <div className='col-lg-3 col-lg-2'>
                            <div className={`menu-vertical menu-vertical__tabs bg-white px-lg-1 px-md-0`}>
                                <ul className='no-list-style mb-3 mb-lg-0 clearfix'>
                                    <li>
                                        <NavLink to={`${match.path}/view`} className='pl-3 py-2 pr-3 pr-lg-0'>{t("my_car_page.tabs.details")}</NavLink>
                                    </li>
                                    <li>
                                        <NavLink to={`${match.path}/details`} className='pl-3 py-2 pr-3 pr-lg-0'>{t("my_car_page.tabs.more")}</NavLink>
                                    </li>
                                    <li>
                                        <NavLink to={`${match.path}/prices`} className='pl-3 py-2 pr-3 pr-lg-0'>{t("my_car_page.tabs.tariffs")}</NavLink>
                                    </li>
                                </ul>
                            </div>
                        </div>
